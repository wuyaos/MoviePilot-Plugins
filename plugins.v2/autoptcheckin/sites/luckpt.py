# input: LuckPT 站点 Cookie、UA、代理配置与 MoviePilot RequestUtils
# output: LuckPT attendance.php POST 签到处理器
...
class LuckPT(_ISiteSigninHandler):
    """
    LuckPT 签到：attendance.php 表单无验证码，POST 即签到。
    """
    ...
    def signin(self, site_info: CommentedMap) -> Tuple[bool, str]:
        ...
        res = RequestUtils(
            cookies=site_cookie,
            ua=ua,
            referer="https://pt.luckpt.de/attendance.php",
            proxies=proxies,
        ).post_res(url="https://pt.luckpt.de/attendance.php", data={})
