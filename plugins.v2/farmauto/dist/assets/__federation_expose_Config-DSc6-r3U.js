...
const _hoisted_4 = { class: "d-flex flex-wrap align-center ga-2 mt-2" };
...
return (_ctx, _cache) => {
  ...
  return (_openBlock$1(), _createBlock$1(_component_v_form, {
    ...
    default: _withCtx(() => [
      _createVNode(_component_v_card_title, { class: "bg-gradient-farm text-white d-flex align-center ga-2 px-3 py-2" }, {
        default: _withCtx(() => [
          ...
          _cache[31] || (_cache[31] = _createElementVNode("span", { class: "text-subtitle-1 text-white" }, "农场配置", -1)),
      ...
      _createVNode(_component_v_card, {
        flat: "",
        class: "rounded border mb-4 config-tabs-card"
      }, {
        default: _withCtx(() => [
                        ...
                        default: _withCtx(() => [
                          _createVNode(_component_v_card_title, { class: "config-section-title section-title-bg d-flex flex-wrap align-center ga-2 px-4 py-3" }, {
                            default: _withCtx(() => [
                              ...
                              _createElementVNode("span", _hoisted_3, _toDisplayString(site.title) + " 策略", 1),
                              _createVNode(_component_v_spacer),
                              _createVNode(_component_v_switch, {
